    ...
    <div className="container">
      <form>
        ...
        <div>
          ...
          <button type="reset" onClick={() => setShowResetPopup(true)} disabled={loading}>
            Reset
          </button>
        </div>
      </form>
      ...
      {showResetPopup && (
        <div className="popup">
          <div className="popup-content">
            ...
            <div>
              <button className="reset-confirm-btn" onClick={handleReset}>Yes</button>
              <button className="reset-cancel-btn" onClick={() => setShowResetPopup(false)}>No</button>
            </div>
          </div>
        </div>
      )}
